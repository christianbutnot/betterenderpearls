...
public class DeepestPearlItem extends EnderpearlItem {

	public DeepestPearlItem(Properties p_41180_) {
		super(p_41180_);
    ...
    public void appendHoverText(ItemStack stack, @Nullable TooltipContext level, List<Component> components, TooltipFlag flag) {
		{
            components.add(Component.literal("15 Uses").withStyle(ChatFormatting.GRAY).withStyle(ChatFormatting.ITALIC));
        } 
