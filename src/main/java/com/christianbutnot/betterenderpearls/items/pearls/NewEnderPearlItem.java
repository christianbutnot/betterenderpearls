...
public class NewEnderPearlItem extends EnderpearlItem {

	public NewEnderPearlItem(Properties p_41180_) {
		super(p_41180_);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag) {
		{
            components.add(Component.literal("4 Uses").withStyle(ChatFormatting.GRAY).withStyle(ChatFormatting.ITALIC));
        } 
